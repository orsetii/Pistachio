...
impl Entry {
    pub fn new(gdt_selector: SegmentSelector, handler: super::HandlerFunc) -> Self {
    ...
    pub fn set_handler_fn(&mut self, handler: super::HandlerFunc) -> &mut EntryOptions {
        let pointer = handler as u64;
...
fn get_cs() -> SegmentSelector {
    ...
    crate::println!("Got CS segment: {}", segment);
